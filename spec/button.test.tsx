...
jest.mock("../src/base-components/button.styles", () => ({
  Styled: { Button: mockButton },
}));

const mockClick = jest.fn();
const DEFAULT_PROPS = { onClick: mockClick, children: "mockChildren" };

describe("Button", () => {
  let renderComponent: () => RenderResult;

  beforeEach(async () => {
    const { Button } = await import("../src/base-components/button");
